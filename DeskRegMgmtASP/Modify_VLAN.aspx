<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Modify_VLAN.aspx.cs" Inherits="DeskRegMgmtASP.Modify_VLAN" %>


<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server" >

    <asp:Label runat="server" Style="margin-left:35%"><a href="RegVlanMgmt.aspx">Return to VLAN Management</a></asp:Label>
    ...
    <asp:Table runat="server" ID="Add_Vlan_Table" Style="margin-top:10px" Width="100%" HorizontalAlign="Center" CssClass="Table_Style">
        ...
        <asp:TableRow ID ="Title">
            <asp:TableCell Text ="Modify VLAN Info"  ColumnSpan="2" HorizontalAlign="Center"  CssClass="Title1"></asp:TableCell>
        </asp:TableRow>
    ...
    <asp:Button ID="modify_vlan" runat="server" Text="Modify" CssClass="button_style" Style="margin-left:45%" OnClick="modify_vlan_Click" />
 </asp:Content>