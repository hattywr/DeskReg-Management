<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegSearchEventTime_true.aspx.cs" Inherits="DeskRegMgmtASP.RegSearchEventTime_true" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

        <asp:Label runat="server" Style="margin-left:45%"><a href="RegSearchEventTime.aspx">Return to Search</a></asp:Label>
     ...
     <asp:Table ID="Search_Results_Table" runat="server" Width="100%" HorizontalAlign="Center" CssClass="Table_Style" Style="margin-top:8px">
        ...
        <asp:TableRow ID ="Title">
            <asp:TableCell ID="table_title" Text = "Time Period Examination"  ColumnSpan="6" HorizontalAlign="Center"  CssClass="Title1"></asp:TableCell>
        </asp:TableRow>
